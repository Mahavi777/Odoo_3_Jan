                    ...
                    {attendanceRecords.length > 0 ? (
                      attendanceRecords.map((record, index) => {
                        ...
                        return (
                          <tr
                            key={index}
                            className={`hover:bg-indigo-50 transition-colors ${record.status === 'Leave' ? 'bg-amber-50' : ''
                              }`}
                          >
                            ...
                            <td className="px-6 py-4">
                              <span className={`inline-flex items-center space-x-1 ${checkIn === '-' ? 'text-gray-400' : 'text-gray-900 font-medium'
                                }`}>
                            ...
                            <td className="px-6 py-4">
                              <span className={`inline-flex items-center space-x-1 ${checkOut === '-' ? 'text-gray-400' : 'text-gray-900 font-medium'
                                }`}>
                            ...
                            <td className="px-6 py-4">
                              <span className={`px-3 py-1 rounded-lg text-sm font-medium ${workHours === '-'
